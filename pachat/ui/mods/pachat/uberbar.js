...
// end of RoomExtendedUserViewModel
    ...
    model.messageLinkClick = function()
    {
      ...
      model.openUrl( part.text );
		...
		var commandList = ['/sethistorylength', '/setcolor', '/tryfixfriends', '/alignright', '/alignleft', '/ownerlist', '/adminlist', '/help', '/join', '/mute', '/unmute', '/kick', '/ban', '/banlist', '/unban', '/setrole', '/setaffiliation'].sort(function(a, b) {
...
//
  ...
  model.hideContextMenu = function()
  {
    ...
    // fix the context menu staying hidden if you open it on a user very low on the screen
